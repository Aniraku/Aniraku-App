...
const styles = StyleSheet.create({
  ...
  heading: { color: nothing.white, fontSize: 10, fontWeight: "800", letterSpacing: 0.6 },
  ...
  presetText: { color: nothing.white, fontWeight: "700", fontSize: 12, letterSpacing: 0.2 },
  ...
  timerText: { color: nothing.red, fontWeight: "800", fontSize: 14, letterSpacing: 0.3, flex: 1, fontVariant: ["tabular-nums"] },
  cancelBtn: { padding: 4 },
  ...
  pillText: { color: nothing.black, fontSize: 12, fontWeight: "800", letterSpacing: 0.2, fontVariant: ["tabular-nums"] },
});
