...
const styles = StyleSheet.create({
  ...
  gifTile: { aspectRatio: 1.1, backgroundColor: nothing.surface, borderRadius: 5, overflow: "hidden", width: "23.5%" },
