...
const styles = StyleSheet.create({
  ...
  gifResults: { maxHeight: 158 },
  gifGrid: { flexDirection: "row", flexWrap: "wrap", gap: 5 },
  gifTile: { aspectRatio: 1.45, backgroundColor: nothing.surface, borderRadius: 5, overflow: "hidden", width: "31.8%" },
