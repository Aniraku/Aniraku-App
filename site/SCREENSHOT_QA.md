...
The v2.1 gallery added only two assets: `profile.jpg`, copied from the verified signed-in device capture above, and `alerts-preview.png`, captured from the implemented guest Alerts interface. v2.2 retains the same truthful gallery: neither is generated imagery nor a mislabeled authenticated notification state.
