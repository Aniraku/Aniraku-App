...
- The visible Schedule and Next Airing surfaces use the existing Aniraku API schedule contract, then retain the verified AniList ID required by the established detail, Watch, and playback routes.
