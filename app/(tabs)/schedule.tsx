...
export default function ScheduleScreen() {
  ...
  const schedule = useQuery({ queryKey: ["schedule", week.startAt, week.endAt], queryFn: () => getAiringSchedule(1, 100, week) });
