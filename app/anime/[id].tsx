...
const styles = StyleSheet.create({
  ...
  relationsSection: { gap: 10 },
  relationsHeading: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-end" },
  relationsList: { gap: 8 },
  relationCard: { minHeight: 86, flexDirection: "row", alignItems: "center", padding: 8, gap: 11 },
  relationPoster: { width: 48, height: 68, overflow: "hidden", alignItems: "center", justifyContent: "center", borderRadius: 9, backgroundColor: nothing.raised },
  relationPosterFallback: { color: nothing.dim, fontFamily: "monospace", fontSize: 8, fontWeight: "900", letterSpacing: 0.55 },
  relationBody: { flex: 1, gap: 4 },
  relationLabel: { color: nothing.red, fontFamily: "monospace", fontSize: 8, fontWeight: "900", letterSpacing: 0.7 },
  relationTitle: { color: nothing.white, fontSize: 14, fontWeight: "900", lineHeight: 18 },
  relationMeta: { color: nothing.muted, fontFamily: "monospace", fontSize: 8, fontWeight: "700", letterSpacing: 0.45 },
  relationArrow: { color: nothing.white, fontSize: 27, fontWeight: "300", lineHeight: 30 },
